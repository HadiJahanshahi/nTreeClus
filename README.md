...
#### Maintained by: Hadi Jahanshahi (hadi.jahanshahi |at| ryerson |dot| ca)
...
## Keywords
sequence mining, categorical time series, model-based clustering, pattern recognition, tree-based learning
